...
class Decoder(object):
    ...
    def x(self):
        ...
        print("layer_dimensions:", layer_dimensions)
        x = tf.layers.dense(
    ...
    def reconstr_loss(self):
        ...
        print("self._reconstruction_target.shape: ", self._reconstruction_target.shape)
        if self._loss == 'L2':
            if self._bootstrap_ratio > 1:
                ...
                l2_val,_ = tf.nn.top_k(l2,k=int(l2.shape[1])//self._bootstrap_ratio)
